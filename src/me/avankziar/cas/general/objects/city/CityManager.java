...
public class CityManager implements MysqlHandable, MemoryHandable
{
	...
	public CityManager(long id, long cityID, UUID uuid, double expenseAllowance)
	{
		setID(id);
		setCityID(cityID);
		setUUID(uuid);
	...
	public ArrayList<Object> get(Connection conn, String tablename, String orderby, String limit, String whereColumn, Object... whereObject)
	{
		try
		{
			...
			while (rs.next()) 
			{
				al.add(new CityManager(rs.getLong("id"),
						rs.getLong("city_id"),
	...
	public static ArrayList<CityManager> convert(ArrayList<Object> arrayList)
	{
		ArrayList<CityManager> l = new ArrayList<>();
		for(Object o : arrayList)
		{
			if(o instanceof CityManager)
			{
				l.add((CityManager) o);
			}
		}
