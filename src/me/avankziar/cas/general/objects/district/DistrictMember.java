...
public class DistrictMember implements MysqlHandable, MemoryHandable
{
	...
	public DistrictMember(long id, long districtID, UUID uuid, double expenseAllowance)
	{
		setID(id);
	...
	public ArrayList<Object> get(Connection conn, String tablename, String orderby, String limit, String whereColumn, Object... whereObject)
	{
		try
		{
			...
			while (rs.next()) 
			{
				al.add(new DistrictMember(rs.getLong("id"),
	...
	public static ArrayList<DistrictMember> convert(ArrayList<Object> arrayList)
	{
		ArrayList<DistrictMember> l = new ArrayList<>();
		for(Object o : arrayList)
		{
			if(o instanceof DistrictMember)
			{
				l.add((DistrictMember) o);
			}
		}
		return l;
	}
	...
	{
		CAS.getPlugin().getMysqlHandler().updateData(MysqlType.DISTRICT_MEMBER, this, "`id` = ?", this.id);
	}
}