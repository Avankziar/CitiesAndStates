...
public enum MysqlType
{
	...
	CITY("casCity", new City(), ServerType.SPIGOT,
			...
			+ " maximum_y int,"
			+ " maximum_z int,"
			+ " city_ifh_account int,"
			+ " city_stored_experience int,"
			+ " would_like_to_level_up boolean,"
			+ " can_level_up boolean,"
			+ " what_needs_to_be_done_message text,"
			+ " last_level_approver text,"
			+ " default_city_manager_expense_allowance double,"
			+ " default_city_member_expense_allowance double,"
			+ " additional_purchased_districts int,"
			+ " additional_purchased_properties int,"
			+ " actual_redstone_blocks_amount int,"
			+ " additional_redstone_blocks_amount int,"
			+ " actual_livestock_amount int,"
			+ " additional_livestock_amount int);"),
