...
import me.avankziar.cas.general.database.MysqlBaseSetup;
import me.avankziar.cas.general.database.ServerType;
import me.avankziar.cas.spigot.CAS;

public class MysqlSetup extends MysqlBaseSetup
{
	public MysqlSetup(CAS plugin, boolean adm, String path)
	{
